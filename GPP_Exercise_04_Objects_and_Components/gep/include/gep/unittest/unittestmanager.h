...
#define GEP_UNITTEST_GROUP(groupId) gep::UnittestGroup g_unittest_##groupId(GEP_STRINGIZE(groupId));
...
Unittest_##groupId##testId g_unittest_##groupId##testId(GEP_STRINGIZE(testId),g_unittest_##groupId); \
