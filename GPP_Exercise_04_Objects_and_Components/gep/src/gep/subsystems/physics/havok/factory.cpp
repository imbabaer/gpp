...
gep::CollisionMesh* gep::CollisionMeshFileLoader::loadResource(CollisionMesh* pInPlace)
{
    ...
    if (container)
    {
        ...
        if (physicsData)
        {
            ...
            IShape* shape = conversion::hk::fromHkShape(const_cast<hkpShape*>(hkShape));
