...
void gpp::Experiments::makeScriptBindings()
{
    ...
    scripting->bindEnum("MotionType",
        "Invalid", gep::Motion::Invalid,
        "Dynamic", gep::Motion::Dynamic,
        "SphereIntertia", gep::Motion::SphereIntertia,
        "BoxInertia", gep::Motion::BoxInertia,
        "MotionKeyframed", gep::Motion::MotionKeyframed,
        "Fixed", gep::Motion::Fixed,
        "ThinBoxInertia", gep::Motion::ThinBoxInertia,
        "Character", gep::Motion::Character,
        0);
    ...
    //Cam
    scripting->bind<gep::FreeCamera>("Cam", m_pFreeCamera);
