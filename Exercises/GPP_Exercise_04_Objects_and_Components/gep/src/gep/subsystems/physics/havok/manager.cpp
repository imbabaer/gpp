...
{
    m_pFactory = new HavokPhysicsFactory();
...
{
    GEP_ASSERT(m_pWorld == nullptr, "This physics system does currently not support setting the active world a second time!");
