...
void gpp::Game::bindOther()
{
    ...
    //////////////////////////////////////////////////////////////////////////
    scripting->bind<gpp::State>("_State");
    scripting->bind<gpp::State::EnterEventData>("EnterEventData");
    scripting->bind<gpp::State::EnterEvent_t>("EnterEvent_t");
    scripting->bind<gpp::State::LeaveEventData>("LeaveEventData");
    scripting->bind<gpp::State::LeaveEvent_t>("LeaveEvent_t");
    scripting->bind<gpp::State::UpdateEventData>("UpdateEventData");
    scripting->bind<gpp::State::UpdateEvent_t>("UpdateEvent_t");
    scripting->bind<gpp::StateMachine>("_StateMachine");
    scripting->bind<gpp::StateMachineFactory>("StateMachineFactory");
...
void gpp::Game::bindEnums()
{
    ...
    scripting->bindEnum("StateUpdateStepBehavior",
        "Continue",                   gpp::State::UpdateStepBehavior::Continue,
        "Leave",                      gpp::State::UpdateStepBehavior::Leave,
        "LeaveWithNoConditionChecks", gpp::State::UpdateStepBehavior::LeaveWithNoConditionChecks,
        0);
