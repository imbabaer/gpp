...
{
    vec3 viewDir = (m_targetPos - m_position).normalized();
    vec3 up = Quaternion(viewDir, -m_tilt).toMat3() * m_upVector;
    return mat4::lookAtMatrix(m_position, m_position + viewDir, up);
}
